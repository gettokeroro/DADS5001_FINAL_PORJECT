"""
Phase 4 — Add Conjunctivitis disease to scoring engine source data
====================================================================

Usage (from project root):
    python scripts/add_conjunctivitis_to_train.py

Idempotent · seed=42 deterministic. See add_influenza_to_train.py for
...
# Eye-focused symptom set · clean separation จากโรคอื่น
SYMPTOM_COUNTS: dict[str, int] = {
    "redness_of_eyes":              100,   # defining symptom
    "watering_from_eyes":            85,
    "puffy_face_and_eyes":           55,   # allergic/viral
    "swelled_lymph_nodes":           40,   # pre-auricular (viral)
    "blurred_and_distorted_vision":  30,   # severe viral
    "mild_fever":                    20,   # mild systemic
    "headache":                      20,   # eye strain
}
