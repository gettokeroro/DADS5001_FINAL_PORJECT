"""
Phase 4 — Add Dehydration disease to scoring engine source data
================================================================

Usage (from project root):
    python scripts/add_dehydration_to_train.py
...
SYMPTOM_COUNTS: dict[str, int] = {
    "dehydration":  100,   # defining symptom — present in every case
    "fatigue":       85,
    "dizziness":     80,
    "sunken_eyes":   70,
    "headache":      65,
    "nausea":        60,
    "cramps":        50,
    "diarrhoea":     50,   # common cause of dehydration
    "vomiting":      45,
}
